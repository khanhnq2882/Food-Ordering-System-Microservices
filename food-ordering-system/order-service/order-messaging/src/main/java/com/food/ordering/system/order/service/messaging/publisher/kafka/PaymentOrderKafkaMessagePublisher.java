...
public class PaymentOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    public PaymentOrderKafkaMessagePublisher(OrderMessagingDataMapper orderMessagingDataMapper,
    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            RestaurantApprovalRequestAvroModel restaurantApprovalRequestAvroModel =
                    orderMessagingDataMapper.orderApprovalEventToRestaurantApprovalRequestAvroModel(domainEvent);
